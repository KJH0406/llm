...
server_url = "https://reasonably-future-creator-ra.trycloudflare.com"
...
user_token_db = {"TEMPTOKEN": "jangho"}
...
def handle_authorize(client_id: str, redirect_uri: str, state: str):
    ...
    <html>
        ...
        <body>
            <h1>Log Into recipes</h1>
            <a href="{redirect_uri}?code=TEMPTOKEN&state={state}">Authorize</a>
        </body>
    </html>
    """
