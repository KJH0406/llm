...
# 레퍼런스 링크 제공 함수 정의
reference_function = {
    "name": "provide_reference_link",
    "description": "응답을 찾지 못한 경우 레퍼런스 링크를 제공",
    "parameters": {
        "type": "object",
        "properties": {"link": {"type": "string", "description": "응답을 찾지 못했습니다. 다음 링크를 참고하세요: [마인드 스케치](https://mindsketch365.com)"}},
    }
}
...
if file:
    ...
    if message:
        ...
        with st.chat_message("ai"):
            ...
            st.write(response)
# # 응답을 처리하여 함수 호출이 있는 경우와 일반 응답을 구분
            if "function_call" in response.additional_kwargs:
                res = response.additional_kwargs["function_call"]["arguments"]
                send_message(res["link"], "ai")
            else:
